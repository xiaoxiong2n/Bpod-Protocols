...
function GoNoGoOutcomePlot(AxesHandle, Action, varargin)
%% 
...
switch Action
    case 'init'
        ...
        % set(AxesHandle,'TickDir', 'out','YLim', [-1.5, 2.5], 'YTick', [-1 0 1 2],'YTickLabel', {'NoGo-','NoGo','Go','NoGo+'}, 'FontSize', 16);
        set(AxesHandle,'TickDir', 'out','YLim', [-0.5, 1.5], 'YTick', [0 1],'YTickLabel', {'NoGo','Go'}, 'FontSize', 16);

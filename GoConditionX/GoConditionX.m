function GoConditionX

% SETUP
% > Connect the water valve in the box to Bpod Port#6.
...
if isempty(fieldnames(S))  % If settings file was an empty struct, populate struct with default settings
    ...
    S.GUIMeta.TrainingLevel.String = {'Habituation','Shaping', 'Task', 'Task_M4'};
        
    S.GUI.PunishDelayMean = 0.1;
    S.PunishDelayMax = 0.1;
    S.PunishDelayMin = 0.1;
    S.GUI.RewardDelayMean = 0.5;
    S.RewardDelayMax = 0.5;
    S.RewardDelayMin = 0.5;
